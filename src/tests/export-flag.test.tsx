...
// Keyed, not blanket: Journey reads two flags now, and a mock that answered
// `flag.on` to both would swap the hero for the sushi sequence every time this
// file turned the export on.
vi.mock('../lib/flags', () => ({
